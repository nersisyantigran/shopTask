...
<div class="fieldcontain ${hasErrors(bean: product, field: 'productionDate', 'error')} required">
    ...
    <input type="date" name="productionDate" required value="${product?.productionDate?.toString()?.take(10)}">
</div>
...
<div class="fieldcontain ${hasErrors(bean: product, field: 'expirationDate', 'error')} required">
    <label for="expirationDate">
        ...
        <input type="date" name="expirationDate" value="${product?.expirationDate?.toString()?.take(10)}">
</div>
